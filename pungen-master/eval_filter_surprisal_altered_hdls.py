    ...
    if not args.from_file:
        ...
        with open(args.outfile, 'w') as outf:
            with open(args.sents_csv_path) as f:
                ...
                out_writer.writerow(['id', 'sentence', 'mod_word', 'orig_word', 'word_id', 'orig_verb',
                ...
                for line in sent_reader:
                    ...
                    sent_id, humor_sent, aug_word, orig_word, word_id, orig_verb = line
                    ...
                    # NOTE: Initially, we just want to look at the scores...
                    ...
                    if keep_sent:
                        out_writer.writerow([sent_id, humor_sent, aug_word, orig_word, word_id, orig_verb,
                                             scores['grammar'], scores['ratio'], scores['local'], scores['global'],
                                             orig_sent_scores['grammar']])
                    else:
